...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2015 at 08:57 AM
...
INSERT INTO `pengusaha` (`id_pengusaha`, `no_ktp`, `nama_pengusaha`, `ttl`, `file_ktp`, `email`, `password`, `username_admin`, `status_akun`) VALUES
(1, '123456789', 'taryo', '0000-00-00', '', 'taryo@gmail.com', 'taryo', 'admin', '');
...
--
ALTER TABLE `pengusaha`
MODIFY `id_pengusaha` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
