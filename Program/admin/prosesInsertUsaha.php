...
<?php
	...
	$sql = "INSERT INTO usaha VALUES(NULL,'$nama','$id_pengusaha','$produk','$alamat','$kelurahan','$kecamatan','$telp','$lat','$lng','$peta','$skala','$sektor','$fileGambar1','$fileGambar2','$fileGambar3','$fileGambar4','$fileGambar5','$status')";
