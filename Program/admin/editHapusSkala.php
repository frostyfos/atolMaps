...
<?php 
    ...
    $sql = "SELECT * FROM skala_usaha where id_skala like ".$_POST['id_skala']."";
    //eksekusi query
...
<head>
    <meta charset="utf-8">
    <title>Olah data Skala Usaha</title>
    ...
    <?php 
        ...
        else if(isset($_POST["delete"]))
        {
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <form class="form-vertical" action="prosesHapusSkala.php" method="post">
                    <input type = "hidden" name = "id_skala" value = "'. $_POST['id_skala'] .'">
                        <table class="table">
                            <tr>
                                <th colspan = "2" class="text-center info"> INFORMASI SKALA USAHA</th>
                            </tr>
                            <tr>
                                <th>ID Skala</th>
                                <td>'.$row['id_skala'].'</td>
