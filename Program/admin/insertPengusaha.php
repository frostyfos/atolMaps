...
<head>
	<meta charset="utf-8">
    <title>Form Insert Pemilik Usaha</title>
    ...
    <!-- disini konten  -->
     ...
     <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <form class="form-horizontal" action="prosesInsertPengusaha.php" enctype="multipart/form-data" method="post" data-toggle="validator" role="form">
